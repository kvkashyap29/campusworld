...
class TextbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create textbook" do
    assert_difference('Textbook.count') do
      post textbooks_url, params: { textbook: { author: @textbook.author, image: @textbook.image, name: @textbook.name, publications: @textbook.publications } }
    end
  ...
  test "should update textbook" do
    patch textbook_url(@textbook), params: { textbook: { author: @textbook.author, image: @textbook.image, name: @textbook.name, publications: @textbook.publications } }
