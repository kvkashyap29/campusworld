...
class AttendencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendence" do
    assert_difference('Attendence.count') do
      post attendences_url, params: { attendence: { date: @attendence.date, status: @attendence.status, student_id: @attendence.student_id } }
    end
  ...
  test "should update attendence" do
    patch attendence_url(@attendence), params: { attendence: { date: @attendence.date, status: @attendence.status, student_id: @attendence.student_id } }
